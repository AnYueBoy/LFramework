    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i, fixed facing : VFACE) : SV_Target
            {
                ...
                float wobble = sin((i.fillPosition.x * _Freq) + (i.fillPosition.z * _Freq) + (_Time.y)) * (_Amplitude *
                    wobbleIntensity);
                ...
                float backfaceFoam = (cutoffTop * smoothstep(0.5 - (0.2 * _Line) - _LineSmooth, 0.5 - (0.2 * _Line),
                    movingfillPosition));
